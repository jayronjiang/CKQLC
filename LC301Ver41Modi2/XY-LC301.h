...
sbit BAR_UP	=P0^0;	//8-chanel output-control.(8-chanel input-detect legcy to P2),À¸¸ËÆð
sbit BAR_DOWN	=P0^1; 	// À¸¸ËÂä
sbit TTL_GREEN	=P0^2;	// ÓêÅïµÆ
sbit VOX_ALM	=P0^3;	// ÉùÒô±¨¾¯Æ÷
sbit LIGHT_ALM	=P0^4;	// ¹â±¨¾¯Æ÷
sbit LAN_LAMP	=P0^5;	// ³µµÀÍ¨ÐÅµÆ
sbit BAK1_USED	=P0^6;
sbit BAK2_USED	=P0^7;
sbit pinSwtichALG =P0^6;  // Ñ¡Ôñ¿ª¹Ø? 0:½µ¸Ü, 1: Ì§¸Ü
//==========================================================================================
